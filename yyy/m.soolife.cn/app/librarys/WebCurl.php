...
class WebCurl extends Component {
	...
	public function get_url($url,$method) {
		...
		}elseif($method == 'old_api'){
			$host = $this -> config -> old_api -> url;
		}elseif($method == 'life_api'){
			$host = $this -> config -> life_api -> url;
		}elseif($method == 'pay'){
            $host = $this -> config -> pay -> url;
		}elseif($method == 'money_api'){
            $host = $this -> config -> money_api -> url;
