...
window.createGoAppBtn = (function(){
	...
	var portKeyDoor = [
						{
						 htmlName:"详情页",
						 testHref:/^http:\/\/item.test.soolife.net\/m\/$/i,
						 portKey:"?object=goods&skuid=",
						 portSku:sku
						},{
						 htmlName:"店铺页",
						 testHref:/^http:\/\/store.test.soolife.net\/m$/i,
						 portKey:"?object=shop&shop_id=",
						 portSku:sku
						},{
						 htmlName:"购物车页",
						 testHref:/^http:\/\/orders.test.soolife.net\/m\/index.html$/i,
...
var webSdk = {
		...
		goodsDetailUrl     : ['http://item.test.soolife.net/m/','.html'],
		instantBuyObj      : "open-instant-buy",
		instantBuyUrl      : ['http://orders.test.soolife.net/m/order/index.html?skuid=','&qty=','&type=','&order_type=true'],
		instantBuyType     : 2,
		instantBuyNumber   : null,
		shopObj            : "open-shop",
		shopUrl            : ['http://store.test.soolife.net/m/','.html'],
		newWebObj          : "open-new-web",
		scanCodeObj 	   : "open-scan-code",
		scanCodeKey 	   : "scancode",
		cartsObj           : "open-carts",
		cartsUrl           : ['http://orders.test.soolife.net/m/index.html'],
		starPowderObj      : "open-star-powder",
		starPowderUrl      : ['http://m.test.soolife.net/business.html'],
		payPurseObj        : "open-pay-purse",
		payPurseUrl        : [null],
		ingitationObj      : "open-ingitation",
		ingitationUrl      : ['http://m.test.soolife.net/starfans.html'],
		overseasBuyObj     : "open-overseas-buy",
		overseasBuyUrl     : ['http://m.test.soolife.net/seagood.html'],
		luxuryLifeObj      : "open-luxury-life",
		luxuryLifeUrl      : ['http://m.test.soolife.net/life.html'],
		myFansShowObj      : "open-my-fans-show",
		myFansShowUrl      : ['http://i.test.soolife.net/m/exist/mystarshow.html'],
		myCouponObj        : "open-my-coupon",
		myCouponUrl        : ['http://i.test.soolife.net/m/exist/mycoupons.html'],
		myIncomeObj        : "open-my-income",
		myIncomeUrl        : ['http://i.test.soolife.net/m/exist/income.html'],
		myInvitedRecordObj : "open-my-invited-record",
		myInvitedRecordUrl : ['http://i.test.soolife.net/m/exist/questrecord.html'],
		addCartsObj 	   : "add-carts",
		addCartsUrl		   : ['http://item.test.soolife.net/m/','.html'],
		addCartsNumber     : null,
		backHomeObj        : "back-home",
		backHomeUrl        : ['http://m.test.soolife.net'],
...
function BaseSdk(){};
	BaseSdk.prototype.backHome = function(obj,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href  =href ||'http://m.test.soolife.net';
				appSDK.popBeforController(_href);
			};
		};
	};
	BaseSdk.prototype.openGoodsDetail = function(obj,id,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href || 'http://item.test.soolife.net/m/'+ id +'.html';
	...
	BaseSdk.prototype.openInstantBuy = function(obj,id,objPara){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				...
				var _href = objFPara.href || 'http://orders.test.soolife.net/m/order/index.html?skuid='+id+'&qty='+buyN+'&type='+buyT+'&order_type=true';
	...
	BaseSdk.prototype.openShop = function(obj,id,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href || 'http://store.test.soolife.net/m/'+ id +'.html';
	...
	BaseSdk.prototype.openCarts = function(obj,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href || 'http://orders.test.soolife.net/m/index.html';
				appSDK.openCarts(_href);
			};
		};
	};
	BaseSdk.prototype.openStarPowder = function(obj,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href || 'http://m.test.soolife.net/business.html';
				appSDK.openStarPowder(_href);
			};
		};
	};
	...
	BaseSdk.prototype.openIngitation = function(obj,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href || 'http://m.test.soolife.net/starfans.html';
				appSDK.openIngitation(_href);
			};
		};
	};
	BaseSdk.prototype.openOverseasBuy = function(obj,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href|| 'http://m.test.soolife.net/seagood.html';
				appSDK.openOverseasBuy(_href);
			};
		};
	};
	BaseSdk.prototype.openLuxuryLife = function(obj,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href || 'http://m.test.soolife.net/life.html';
				appSDK.openLuxuryLife(_href);
			};
		};
	};
	BaseSdk.prototype.openMyFansShow = function(obj,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href || 'http://i.test.soolife.net/m/exist/mystarshow.html';
				appSDK.openMyFansShow(_href);
			};
		};
	};
	BaseSdk.prototype.openMyCoupon = function(obj,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href || 'http://i.test.soolife.net/m/exist/mycoupons.html';
				appSDK.openMyCoupon(_href);
			};
		};
	};
	BaseSdk.prototype.openMyIncome = function(obj,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href || 'http://i.test.soolife.net/m/exist/income.html';
				appSDK.openMyIncome(_href);
			};
		};
	};
	BaseSdk.prototype.openMyInvitedRecord = function(obj,href){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = href || 'http://i.test.soolife.net/m/exist/questrecord.html';
				appSDK.openMyInvitedRecord(_href);
			};
		};
	};
	BaseSdk.prototype.addCarts = function(obj,id,objPara){
		...
		for(var i = 0;i < obj.length;i++){
			obj[i].onclick = function(){
				var _href = objFPara.href || 'http://item.test.soolife.net/m/'+id+'.html';
