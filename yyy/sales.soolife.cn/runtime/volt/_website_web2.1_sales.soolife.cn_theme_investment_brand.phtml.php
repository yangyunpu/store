...
<!-- 微信分享 -->
	...
	<div class="wrap">
		...
		<div class="invitation">
	     ...
	     <div class="i-content">
           ...
           <!--   <div class="underground"><span>08.02 SHANGHAI</span></div> -->
             <div class="tech-process">
             	<img  src="/public/mobile/img/investment/liucheng.png">
             </div>
             <div class="address">
             <p>会议时间：2017年9月27日(星期三) 14:00</p>
		...
		<div class="lj_input tops">
			...
			<input type="hidden" name="type" class="place_input" value="1" />
		</div>
	...
	<!-- <div class="lj_iphones"><a href="tel:15221711405"><img src="/public/mobile/img/investment/iphones.png"></a></div> -->
	<div class="lj_iphones"><a href="tel:<?= $res['mobile'] ?>"><img src="/public/mobile/img/investment/iphones.png"></a></div>
</body>
