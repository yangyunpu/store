...
<div class="index_wrap">
	<div class="header">
		...
		<span class="head_title">体验店列表</span> 
	</div>
	<!-- 下载框 -->
	...
	<?php if ($store['list']) { ?>
		<ul id="store_list">
		<?php foreach ($store['list'] as $d) { ?>
		<li>
			<a href="/lifehui/storedetail.html?store_id=<?= $d['store_id'] ?>">
			    <img class="logo" src="<?= $d['logo'] ?>">
				<div class="txt">
					<p class="name"><?= $d['store_name'] ?></p>
					<p class="adress"><?= $d['address'] ?></p>
				</div>
