...
class Module
{
	...
	public function registerAutoloaders()
	{
		...
		$loader->registerNamespaces(array(
			'Soolife\Cms\Mobile\Controllers' => ROOT_PATH.'/apps/section/mobile/controllers/'
		));
	...
	public function registerServices(DiInterface $di)
	{
		$di->set('dispatcher', function() {
			...
			$dispatcher->setDefaultNamespace("Soolife\Cms\Mobile\Controllers\\");
			return $dispatcher;
		});
		...
		$di->set('view', function() {
			...
			$view->setViewsDir(ROOT_PATH.'/apps/section/mobile/views/');
