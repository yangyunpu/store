...
<div class="getpacketmain">
    <div class="banner">
		<img src="../public/img/starfans/bg_ying ling xing bi.png" alt="">
		<div class="packetnew">
			<h3>
			...
			<p>
			    ...
			    <?php if ($id == 1) { ?>
			        <a id="share_btn">发送我的邀请链接</a>
				<?php } else { ?>
				    <a href="/index.html">立即使用</a>
				<?php } ?>
		</div>
	</div>
<?php if ($sharepage) { ?>
...
<div id="footer">
	...
	<div>
		...
		<p>4、每个新会员仅可获得一次新人红包。</p>
		<p>5、如若恶意注册、作弊领取、恶意批发、恶意刷单、盗用或冒用他人信息参加活动此ID用户则被取消活动资格。</p>
		<p>6、红包限量1000份，送完即止。</p>
		<p>7、最终解释权归如此生活所有。</p>
	</div>
</div>
